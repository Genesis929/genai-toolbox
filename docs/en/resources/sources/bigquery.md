...
| useClientOAuth            |  string  |    false     | If true, forwards the client's OAuth access token to downstream queries. (default: false). If a header name is provided, it will be used instead of "Authorization". |
